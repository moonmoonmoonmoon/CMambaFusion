...
from ..customed_modules.input_layer import LidarInputLayer
from ..customed_modules.asymdil_input_layer import LidarInputLayerAsymDil
from ..customed_modules.asymconv import AsymmetricDownsample
from ..customed_modules.c2f_cbam import C2f_CBAM
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolo11n.yaml", ch=3, nc=None, verbose=True):
        ...
        print('Overriding nc is the same!')
    ...
    base_modules = frozenset(
        {
            ...
            A2C2f,
            LidarInputLayer,
            LidarInputLayerAsymDil,
            AsymmetricDownsample,
            C2f_CBAM,
        }
    )
