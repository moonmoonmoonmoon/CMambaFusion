...
class DemoDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True,
                 root_path=None, logger=None, ext='.bin'):
        super().__init__(
    ...
    def _find_image(self, bin_path):
        ...
        img_dir = Path('/home/yanan/Downloads/projects/multimodal_detection/data/Bus/test/images')
...
def parse_config():
    ...
    parser.add_argument('--data_path', type=str, default='/home/yanan/Downloads/projects/multimodal_detection/data/custom/testing/data/bus_30_03_pcd_out_004306.bin',
