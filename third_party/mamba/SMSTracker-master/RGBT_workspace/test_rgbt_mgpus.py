...
from lib.test.tracker.SMSTracker import SMSTracker
import lib.test.parameter.SMSTracker as rgbt_prompt_params
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=300, debug=0, script_name='SMSTracker'):
    ...
    if script_name == 'SMSTracker':
        params = rgbt_prompt_params.parameters(yaml_name, epoch)
        mmtrack = SMSTracker(params)  # "GTOT" # dataset_name
