...
def check_and_load_precomputed_results(trackers, dataset, report_name, yaml_name: str, force_evaluation=False, **kwargs):
    # Load data
    cfg = env_setting(yaml_name)

    # Load pre-computed results
    result_plot_path = os.path.join(cfg.analysis.result_plot_path, report_name)
    ...
    if os.path.isfile(eval_data_path) and not force_evaluation:
        ...
        eval_data = extract_results(trackers, dataset, report_name, yaml_name, **kwargs)
