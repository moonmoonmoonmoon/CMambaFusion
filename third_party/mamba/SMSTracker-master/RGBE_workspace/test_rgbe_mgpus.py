...
import lib.test.parameter.SMSTracker as rgbe_prompt_params
...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=60, debug=0, script_name='prompt'):
    ...
    if script_name == 'SMSTracker':
        ...
        ostrack = SMSTracker(params)  # "VisEvent"
        tracker = LeeNet_RGBE(tracker=ostrack)
...
if __name__ == '__main__':
    ...
    if dataset_name == 'VisEvent':
        seq_home = "/media/star/data/Leezed/dataset/VisEvent/test/"
