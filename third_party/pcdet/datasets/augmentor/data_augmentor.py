...
class DataAugmentor(object):
    def __init__(self, root_path, augmentor_configs, class_names, logger=None, gt_name_remap=None, data_type=None):
    ...
    def gt_sampling(self, config=None):
        db_sampler = database_sampler.DataBaseSampler(
            ...
            logger=self.logger,
            gt_name_remap=self.gt_name_remap,
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        # print('data_dict[point]: ',data_dict['points'].shape) (144181, 4)
